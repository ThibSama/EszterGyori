...
import {
  ...
  adminPrivacyRequestCreateRequestSchema,
  adminPrivacyRequestResponseSchema,
  adminPrivacyRequestsQueryRequestSchema,
...
const schemaTargets: SchemaTarget[] = [
  ...
  },
  {
    ...
    description: "Active catalog services with the name, description, duration and managed image the reservation page renders (ESZ-149).",
  ...
  },
  {
    ...
    schema: adminServicesResponseSchema,
    io: "output",
  },
  {
    file: "admin-service-mutation-request.schema.json",
    title: "AdminServiceMutationRequest",
    description: "Closed, explicit create, update, archive or restore command for one catalog service.",
    schema: adminServiceMutationRequestSchema,
    io: "input",
  },
  {
    file: "admin-service-response.schema.json",
    title: "AdminServiceResponse",
    description: "The stored service after a mutation; this is what the back-office renders.",
    schema: adminServiceResponseSchema,
    io: "output",
  },
  {
    file: "admin-privacy-request-create-request.schema.json",
    title: "AdminPrivacyRequestCreateRequest",
    description:
      "ESZ-163 — records one reviewed GDPR request: the frozen type, the reception date and exactly the selected booking references.",
    schema: adminPrivacyRequestCreateRequestSchema,
    io: "input",
  },
  {
    file: "admin-privacy-request-response.schema.json",
    title: "AdminPrivacyRequestResponse",
    description: "One register record, with its automatic status and the deadline derived from its reception date.",
    schema: adminPrivacyRequestResponseSchema,
    io: "output",
  },
  {
    file: "admin-privacy-requests-query-request.schema.json",
    title: "AdminPrivacyRequestsQueryRequest",
    description: "Reads the register: one history page (newest first, typed cursor) or one record by id.",
    schema: adminPrivacyRequestsQueryRequestSchema,
    io: "input",
  },
  {
    file: "admin-privacy-requests-response.schema.json",
    title: "AdminPrivacyRequestsResponse",
    description: "One page of the register with its completeness and continuation.",
    schema: adminPrivacyRequestsResponseSchema,
    io: "output",
  },
  {
    file: "admin-privacy-request-search-request.schema.json",
    title: "AdminPrivacyRequestSearchRequest",
    description:
      "Resolves a requester's scope: one booking by current or legacy reference, or one page of an e-mail's live bookings.",
    schema: adminPrivacyRequestSearchRequestSchema,
    io: "input",
  },
  {
    file: "admin-privacy-request-search-response.schema.json",
    title: "AdminPrivacyRequestSearchResponse",
    description: "The matched bookings the administrator selects from, bounded, with hasMore and a typed cursor.",
    schema: adminPrivacyRequestSearchResponseSchema,
    io: "output",
  },
  {
  ...
  {
    file: "public-legal-information-response.schema.json",
    title: "PublicLegalInformationResponse",
    description: "ESZ-165 — the stored legal document, as the public pages read it.",
    schema: publicLegalInformationResponseSchema,
    io: "output",
  },
  {
    file: "admin-legal-information-response.schema.json",
    title: "AdminLegalInformationResponse",
    description: "ESZ-165 — the legal document with its revision and last write, as the admin reads and saves it.",
    schema: adminLegalInformationResponseSchema,
    io: "output",
  },
  {
    file: "admin-legal-information-save-request.schema.json",
    title: "AdminLegalInformationSaveRequest",
    description: "ESZ-165 — replaces the legal document whole under the revision the admin last read.",
    schema: adminLegalInformationSaveRequestSchema,
    io: "input",
  },
  {
...
function buildHttpContractDocument(): unknown {
  return {
    ...
    legal: {
      paths: {
        public: PUBLIC_LEGAL_INFORMATION_PATH,
        admin: ADMIN_LEGAL_INFORMATION_PATH,
      },
      policy: legalInformationPolicy,
    },
    ...
    endpoints: [
      ...
      },
      {
        ...
        methods: ["GET", "PATCH"],
        statuses: [200, 400, 401, 403, 404, 405, 409, 500],
        requestBodySchema: "admin-service-mutation-request.schema.json",
        successBodySchema: "admin-service-response.schema.json",
      },
      {
        path: ADMIN_PRIVACY_REQUESTS_PATH,
        methods: ["POST"],
        statuses: [200, 400, 401, 403, 404, 405, 500],
        requestBodySchema: "admin-privacy-request-create-request.schema.json",
        successBodySchema: "admin-privacy-request-response.schema.json",
      },
      {
        path: ADMIN_PRIVACY_REQUESTS_QUERY_PATH,
        methods: ["POST"],
        statuses: [200, 400, 401, 404, 405, 500],
        requestBodySchema: "admin-privacy-requests-query-request.schema.json",
        successBodySchema: "admin-privacy-requests-response.schema.json",
      },
      {
      ...
      {
        path: PUBLIC_LEGAL_INFORMATION_PATH,
        methods: ["GET"],
        statuses: [200, 405, 500],
        successBodySchema: "public-legal-information-response.schema.json",
      },
      {
        path: ADMIN_LEGAL_INFORMATION_PATH,
        methods: ["GET", "PUT"],
        statuses: [200, 400, 401, 403, 405, 409, 500],
        requestBodySchema: "admin-legal-information-save-request.schema.json",
        successBodySchema: "admin-legal-information-response.schema.json",
      },
      {
